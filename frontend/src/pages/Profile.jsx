                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="mb-4">
                                ...
                                {profileErrors.firstName && (
                                    <div className="text-red-600 mt-1">{profileErrors.firstName}</div>
                                )}
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                {profileErrors.lastName && (
                                    <div className="text-red-600 mt-1">{profileErrors.lastName}</div>
                                )}
                            </div>
                    ...
                    <form onSubmit={handlePasswordSubmit}>
                        <div className="mb-4">
                            ...
                            {passwordErrors.newPassword && (
                                <div className="text-red-600 mt-1">{passwordErrors.newPassword}</div>
                            )}
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            {passwordErrors.confirmPassword && (
                                <div className="text-red-600 mt-1">{passwordErrors.confirmPassword}</div>
                            )}
                        </div>
